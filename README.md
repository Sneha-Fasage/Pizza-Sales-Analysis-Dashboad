...
Power BI Desktop – Main data visualization platform used for report creation & dashboard development.
Microsoft Excel / CSV – Data source & preprocessing.
DAX (Data Analysis Expressions) – Used for KPI calculations, measures, dynamic visuals, and conditional logic.
...
Category & Size Insights: % of Sales by Pizza Category, % of Sales by Pizza Size, Sales contribution analysis.
Best Sellers Analysis: Top 5 Pizzas by Revenue, Top 5 Pizzas by Quantity, Top 5 Pizzas by Total Orders.
Worst Sellers Analysis: Bottom 5 Pizzas by Revenue, Bottom 5 Pizzas by Quantity, Bottom 5 Pizzas by Total Orders.
